...
def main(**kwargs):
    ...
    with open('/Users/titoyslas/workspace/vandy/dsp-cs6381/dsp-final/perf/large/latencies.csv', 'w') as f:
    ...
    with open('/Users/titoyslas/workspace/vandy/dsp-cs6381/dsp-final/perf/large/throughput.csv', 'w') as f:
        csv_writer = csv.writer(f)
        for t in throughput:
